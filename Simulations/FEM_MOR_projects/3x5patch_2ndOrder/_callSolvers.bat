...
REM call EM_WaveSolver.exe %* %freq% +directMatlab +fieldValues +fieldFunctional
call EM_WaveSolver.exe %* %freq% +singleEnded +directMatlab +fieldValues +fieldFunctional
echo 
echo.
pause